...
| API Throughput         | 40 reqs/s      | 40 reqs/s      | 80 reqs/s       | 200 reqs/s      | Custom     |
| Node Throughput (CU/s) | 100            | 100            | 100             | 300             | Unlimited  |
| Number of Nodes        | 2              | 5              | 20              | Unlimited       | Unlimited  |
...
For current plan pricing, see [moralis.com/pricing](https://moralis.com/pricing).
