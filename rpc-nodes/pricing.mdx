...
| Throughput       | 40 reqs/s      | 40 reqs/s      | 80 reqs/s       | 200 reqs/s      | Custom     |
| Number of Nodes  | 2              | 5              | 20              | Unlimited       | Unlimited  |
| Archive Requests | Yes            | Yes            | Yes             | Yes             | Yes        |

Throughput is shared across all Moralis products and is measured in requests per second, evaluated over a rolling 4-second window. See [Rate Limits](/data-api/resources/rate-limits) for details.
