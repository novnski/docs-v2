...
- [How to Authenticate Users with MetaMask](/get-started/tutorials-and-guides/auth-api-tutorials/how-to-authenticate-users-with-meta-mask)
- [How to Authenticate Users with RainbowKit](/get-started/tutorials-and-guides/auth-api-tutorials/how-to-authenticate-users-with-rainbow-kit)
- [How to Authenticate Users with WalletConnect](/get-started/tutorials-and-guides/auth-api-tutorials/how-to-authenticate-users-with-wallet-connect)
- [How to Authenticate Users with Coinbase Wallet](/get-started/tutorials-and-guides/auth-api-tutorials/how-to-authenticate-users-with-coinbase-wallet)
- [How to Authenticate Users with Web3Auth](/get-started/tutorials-and-guides/auth-api-tutorials/how-to-authenticate-users-with-web3-auth)
- [How to Authenticate Users with Magic.Link](/get-started/tutorials-and-guides/auth-api-tutorials/how-to-authenticate-users-with-magic-link)