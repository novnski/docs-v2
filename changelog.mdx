...
<Update label="May 27, 2026" tags={["New Feature"]}>
  ...
  **Use cases:** Bitcoin wallets, custody platforms, block explorers, BTC analytics, and multi-chain platforms extending their Bitcoin coverage.
  ...
  See the [Bitcoin Data API overview](/data-api/bitcoin/bitcoin-index) for the full endpoint list and schemas, or start with the [Bitcoin Quickstart](/get-started/tutorials/data-api/bitcoin/bitcoin-quickstart).

  [Explore the Bitcoin Data API →](/data-api/bitcoin/bitcoin-index)
</Update>
