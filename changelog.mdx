...
<Update label="August 26, 2026" tags={["Deprecation"]}>
  ## Moonbeam, Moonriver and Lisk Deprecate on September 25, 2026
...
<Update label="August 11, 2026" tags={["Deprecation"]}>
  ...
  <Note>
    **Updated August 26, 2026.** Both chains stopped producing new blocks on August 1, 2026, so there has been no real-time data to serve since then. Historical data stayed available and is now scheduled for removal on **September 25, 2026**. See [Moonbeam, Moonriver and Lisk Deprecate on September 25, 2026](#moonbeam-moonriver-and-lisk-deprecate-on-september-25-2026) for the current timeline.
  </Note>
