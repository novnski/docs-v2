...
<Update label="August 26, 2026" tags={["Deprecation"]}>
  ...
  **Moonbeam** (`0x504`) and **Moonriver** (`0x505`) stopped producing new blocks on **August 1, 2026**, and Moralis removed real-time support for both chains on **August 21, 2026**. Historical data was left in place, so read requests kept returning records up to the final block on each chain.
  ...
  **Timeline**
  ...
  | August 1, 2026 | Moonbeam and Moonriver stopped producing new blocks |
  | August 21, 2026 | Moralis removed real-time support. Streams stopped emitting webhooks, and responses had already stopped advancing at the final block |
