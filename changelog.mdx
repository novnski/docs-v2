...
<Update label="June 30, 2026" tags={["Deprecation"]}>
  ...
  The following endpoints are now deprecated and will be removed on **July 31, 2026** (30 days from today). If you rely on any of them, please migrate before that date. [Reach out to the team](https://admin.moralis.com/) (via chat widget) if you need help identifying replacements.
