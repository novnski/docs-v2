...
<Update label="August 26, 2026" tags={["Deprecation"]}>
  ...
  **Moonbeam** (`0x504`) and **Moonriver** (`0x505`) stopped producing new blocks on **August 1, 2026**, so there has been no real-time data to serve since then. Historical data was left in place, and read requests have kept returning records up to the final block on each chain.
  ...
  **Timeline**
  ...
  | August 1, 2026 | Moonbeam and Moonriver stopped producing new blocks. No real-time data from this point, and streams stopped emitting webhooks |
...
<Update label="August 11, 2026" tags={["Deprecation"]}>
  ...
  <Note>
    **Updated August 26, 2026.** Both chains stopped producing new blocks on August 1, 2026, so there has been no real-time data to serve since then. Historical data stayed available and is now scheduled for removal on **September 25, 2026**. See [Moonbeam and Moonriver Historical Data Removal](#moonbeam-and-moonriver-historical-data-removal-september-25-2026) for the current timeline.
  </Note>

  Moralis API support for **Moonbeam** (`0x504`) and **Moonriver** (`0x505`) is being removed. Both chains stopped producing new blocks on **August 1, 2026**, and historical support for both is removed on **September 25, 2026**.

  Following [Moonbeam's network relaunch on Base](https://moonbeam.network/news/moonbeam-strategic-update-moonbeam-network-relaunches-on-base/), GLMR has fully migrated from the Moonbeam Polkadot parachain to Base as a 1:1 ERC-20 token, and [MOVR has migrated to Base](https://moonbeam.network/news/moonriver-strategic-update-movr-is-migrating-to-base/) on the same terms. Holder bridging closed on July 31, 2026, both original networks stopped producing new blocks on August 1, 2026, and both have wound down.

  **What's changing:**

  - **Data API:** wallet, token, NFT, DeFi, and price endpoints no longer return new Moonbeam or Moonriver data, since neither chain has produced a block since August 1, 2026. Historical records up to the final block are still returned until September 25, 2026.
  ...
  - **Streams:** existing Moonbeam and Moonriver streams no longer emit webhook notifications, since there are no new blocks, and should be deleted from your workspace.
