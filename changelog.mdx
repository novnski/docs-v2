...
<Update label="June 4, 2026" tags={["Deprecation"]}>
  ...
  As [announced on May 5](#), the following endpoints and APIs have now been **removed** as of June 4, 2026. Requests to these endpoints will return an error. If you are still calling any of them, migrate to the replacements below.
