...
<RecipeMigrationCallout
  items={[
    { path: "GET /wallets/{address}/tokens", guide: "wallet-tokens", label: "Wallet token balances & prices" },
    { path: "GET /{address}/erc20", guide: "wallet-erc20", label: "Wallet ERC-20 balances" },
    { path: "GET /wallets/{address}/net-worth", guide: "wallet-networth", label: "Wallet net worth" },
  ]}
/>
