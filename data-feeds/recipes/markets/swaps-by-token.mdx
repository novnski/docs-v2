...
<RecipeMigrationCallout
  items={[
    { path: "GET /tokens/{address}/analytics", guide: "token-analytics", label: "Token trading analytics" },
    { path: "GET /pairs/{address}/ohlcv", guide: "pair-ohlcv", label: "Pair OHLCV candlesticks" },
  ]}
/>
