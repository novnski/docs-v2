...
| `circulating_supply` | — | add yourself |
| `implementations` | match the token across the chains you index, or a multichain token list | add yourself |
| `logo`, `logo_hash`, `thumbnail` | — | add yourself |
| `possible_spam`, `verified_contract`, `validated`, `security_score` | — | add yourself |
| `categories`, `links`, `description`, `address_label` | — | add yourself |
