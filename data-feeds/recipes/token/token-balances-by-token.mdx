...
for those endpoints lives on the [Token Holders](/data-feeds/recipes/token/token-holders#migrating-from-the-rest-api)
recipe — this page is the same balance data in its raw by-token shape.
</Note>
