...
<RecipeMigrationCallout
  items={[
    { path: "GET /erc20/{address}/owners", guide: "erc20-owners", label: "Token owners (holders)" },
    { path: "GET /erc20/{address}/holders", guide: "erc20-holders", label: "Token holders summary" },
    { path: "GET /erc20/{address}/holders/historical", guide: "holders-historical", label: "Historical token holders" },
  ]}
/>
