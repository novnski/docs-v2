---
title: "Token Stats"
description: "Maintain per-token transfer counters (how many transfers a token has had) as a continuous, reorg-safe aggregate in your own database. Mirrors the Moralis GET /erc20/{address}/stats endpoint."
---
