---
title: "How Data Feeds Works"
sidebarTitle: "How It Works"
description: "Understand the Data Feeds workflow: start from a template or a custom schema, configure your pipeline, and have indexed blockchain data delivered into your own database."
---
...
Start from a **template** or define a **custom schema**:

- **Templates** – ready-made blueprints that reconstruct popular Moralis endpoints (wallet history, balances, prices, swaps, holders, raw logs). The fastest on-ramp. [Browse templates →](/data-feeds/templates/overview)
...
- Define your data models and field mappings (or adapt a template's)
