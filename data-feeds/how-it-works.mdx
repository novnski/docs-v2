...
description: "Understand the Data Feeds workflow: start from a recipe or a custom schema, configure your pipeline, and have indexed blockchain data delivered into your own database."
---
