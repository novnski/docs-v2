---
title: "Reorgs: How Chain Reorganizations Surface, and How Templates Correct Them"
...
The template's own example queries already follow this rule, so if you start from those you get it automatically.
Postgres and MySQL template variants are intended for `historical` backfill of settled blocks, where reorgs do
