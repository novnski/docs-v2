...
|---|---|
| A **stream config** (addresses, topics, ABIs) | A **template** plus SQL filters, e.g. [token-transfers](/data-feeds/templates/token/token-transfers), [contract-logs](/data-feeds/templates/logs/contract-logs) filtered to your addresses or topics |
...
1. Run the **[quickstart](/data-feeds/migration/quickstart)**: live decoded data in your own Postgres in about
   ten minutes.
2. Find the [template](/data-feeds/templates/overview) closest to what your stream watches (token transfers, contract
