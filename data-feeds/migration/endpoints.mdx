...
| # | REST endpoint | Recipes you need | Headline fidelity |
|---|---|---|---|
...
The removed Solana **token-holder** endpoints map onto the same holder recipes, pointed at Solana (the feed's
