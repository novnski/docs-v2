---
title: "Logs by Event Signature"
sidebarTitle: "Logs by Event Signature"
description: "Sync every raw event log of one signature, every Transfer, Approval, or Swap, across all contracts, chain-wide, into your own database. The by-event-type sibling of Contract Logs."
---
...
Identical columns to [Contract Logs](/data-feeds/templates/logs/contract-logs#full-schema), the only difference is the sort key leads with `topic0`. Keep the columns you need (see [Schema & flexibility](/data-feeds/templates/overview#schema--flexibility)).
...
<Columns cols={2}>
  <Card title="Contract Logs" href="/data-feeds/templates/logs/contract-logs" icon="file-lines">
