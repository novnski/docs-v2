const MOONBEAM_REMOVAL_DATE = "August 21, 2026";
...
export const MoonbeamDeprecation = () => (
  <MoonbeamCallout>
    <strong>Deprecated. Migrate to Base.</strong> Moralis support for Moonbeam (
    <code>0x504</code>) and Moonriver (<code>0x505</code>) is removed on{" "}
    ...
    <a href="/changelog">deprecation notice</a> for details.
  </MoonbeamCallout>
);

export const MoonbeamChainsNote = () => (
  <MoonbeamCallout>
    <strong>Moonbeam and Moonriver are deprecated.</strong> Support for both
    chains is removed on <strong>{MOONBEAM_REMOVAL_DATE}</strong>, following
    Moonbeam's network relaunch on Base. GLMR and MOVR are now ERC-20 tokens on
    Base, so migrate to the <code>base</code> chain parameter. See the{" "}
    <a href="/changelog">deprecation notice</a> for contract addresses and
    details.
  </MoonbeamCallout>
);
