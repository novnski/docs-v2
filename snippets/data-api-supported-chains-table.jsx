export const DataApiSupportedChainsTable = () => {
  ...
  const chains = [
    ...
    { name: "Chiliz Testnet", type: "Testnet", chainId: "0x15b32 (88882)", qp: ["chiliz testnet", "0x15b32"], s: mk(T, T, T, T, F, T, T, F, F, T, F, F, F) },
    ...
    { name: "Moonbase", type: "Testnet", chainId: "0x507 (1287)", qp: ["moonbase", "0x507"], s: mk(T, T, T, T, F, T, T, F, F, F, F, F, F) },
    ...
    { name: "Lisk Sepolia Testnet", type: "Testnet", chainId: "0x106a (4202)", qp: ["lisk-sepolia", "0x106a"], s: mk(T, T, T, T, F, T, T, F, F, T, F, F, F) },
