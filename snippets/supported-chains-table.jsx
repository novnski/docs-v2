export const SupportedChainsTable = () => {
  ...
  const chains = [
    ...
    { name: "Moonbeam", type: "Mainnet", chainId: "0x504 (1284)", deprecated: true, depNote: "Support removed on September 25, 2026. Migrate to Base.", depHref: "/changelog#moonbeam-moonriver-and-lisk-support-ends-september-25-2026", s: mk(true, true, true, true, true) },
    { name: "Moonriver", type: "Testnet", chainId: "0x505 (1285)", deprecated: true, depNote: "Support removed on September 25, 2026. Migrate to Base.", depHref: "/changelog#moonbeam-moonriver-and-lisk-support-ends-september-25-2026", s: mk(true, true, true, true, true) },
    ...
    { name: "Lisk", type: "Mainnet", chainId: "0x46f (1135)", deprecated: true, depNote: "Support removed on September 25, 2026. Migrate to Ethereum or Base.", depHref: "/changelog#moonbeam-moonriver-and-lisk-support-ends-september-25-2026", s: mk(true, true, true, true, false) },
