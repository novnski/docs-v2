export const SupportedChainsTable = () => {
  ...
  const chains = [
    ...
    { name: "Chiliz Testnet", type: "Testnet", chainId: "0x15b32 (88882)", s: mk(true, true, true, false, true) },
    ...
    { name: "Moonbase", type: "Testnet", chainId: "0x507 (1287)", s: mk(true, true, true, true, true) },
    ...
    { name: "Lisk Sepolia Testnet", type: "Testnet", chainId: "0x106a (4202)", s: mk(true, true, true, true, false) },
