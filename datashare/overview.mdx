---
title: "Datashare"
description: "Moralis DataShare is a blockchain data export service that delivers massive, decoded datasets across supported chains. Users can export historical data in formats like Parquet, CSV, or JSON, either as downloadable files or to supported S3-compatible storage. These outputs can then be ingested into data platforms like BigQuery, Snowflake, or Databricks for analytics and downstream workflows."
---
...
<iframe
  ...
  title="Export Blockchain Data Sets to CSV"
  width="100%"
  height="400"
  frameBorder="0"
