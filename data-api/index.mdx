...
Our [Universal API](/data-api/universal/index) supports cross-chain endpoints that work across **EVM and Solana**, using unified schemas wherever possible. Ideal for applications that need to support multiple chains without maintaining separate integrations.
