...
<Columns cols={3}>
  <Card title="Wallet API" icon="wallet" href="/data-api/wallet-api/index">
    Wallet history, transfers balances, tokens and PnL.
  </Card>
  <Card title="Token API" icon="hexagon-plus">
    Token search, balances, transfers, holders and swaps.
  </Card>
  <Card title="NFT API" icon="shield-cat">
    Metadata, floor prices, transfers and ownership.
  </Card>
  <Card title="Price API" icon="chart-candlestick">
    Real-time crypto prices, OHLC, trading volume.
  </Card>
  <Card title="DeFi API" icon="chart-line-up">
    DeFi positions, liquidity, reserves and token pairs.
  </Card>
  <Card title="Blockchain API" icon="cubes">
