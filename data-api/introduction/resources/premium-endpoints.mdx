...
| Endpoint | Method | Path | Required Plan | CUs |
|----------|--------|------|---------------|-----|
| [Entity Search](/data-api/universal/entity/endpoints/entity-search) | GET | `/entities/search` | Pro | 50 |
| [Get Entity](/data-api/universal/entity/endpoints/entity-by-id) | GET | `/entities/{entityId}` | Pro | 50 |
| [Get Entities by Category](/data-api/universal/entity/endpoints/entity-by-category) | GET | `/entities/categories/{categoryId}` | Pro | 50 |
| [Get Entity Categories](/data-api/universal/entity/endpoints/entity-categories) | GET | `/entities/categories` | Pro | 10 |
