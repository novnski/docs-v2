---
title: "Performance"
description: "Performance characteristics of Moralis APIs, including latency percentiles, supported request rates, data freshness, uptime, and enterprise SLAs."
---
...
- Platform uptime and incident history are publicly available at:\
  [**status.moralis.io**](https://status.moralis.io)