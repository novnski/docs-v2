...
| ------------------------------------------------------------------------- | ------------------------------- |
| [Wallet History](/data-api/evm/wallet/activity/wallet-history)    | Complete decoded activity feed  |
| [Token Balances](/data-api/evm/wallet/token-balances)             | Current ERC-20 holdings         |
| [NFT Balances](/data-api/evm/wallet/nft-balances/nft-balances)    | Current NFT holdings            |
| [Net Worth](/data-api/evm/wallet/net-worth)                       | Total wallet value in USD       |
| [Wallet P&L](/data-api/evm/wallet/pn-l/wallet-pn-l)               | Profit/loss per token           |
...
- [NFT Balances](/data-api/evm/wallet/nft-balances/nft-balances)
- [Wallet History](/data-api/evm/wallet/activity/wallet-history)
