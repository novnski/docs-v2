...
| ------------------------------------------------------------------------- | ------------------------------- |
| [Wallet History](/data-api/evm-api/wallet-api/activity/wallet-history)    | Complete decoded activity feed  |
| [Token Balances](/data-api/evm-api/wallet-api/token-balances)             | Current ERC-20 holdings         |
| [NFT Balances](/data-api/evm-api/wallet-api/nft-balances/nft-balances)    | Current NFT holdings            |
| [Net Worth](/data-api/evm-api/wallet-api/net-worth)                       | Total wallet value in USD       |
| [Wallet P&L](/data-api/evm-api/wallet-api/pn-l/wallet-pn-l)               | Profit/loss per token           |
| [Decoded Transactions](/data-api/evm-api/wallet-api/decoded-transactions) | Human-readable transaction data |
