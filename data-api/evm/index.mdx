...
<Columns cols={3}>
  <Card icon="wallet" href="/data-api/evm/wallet/index" title="Wallet API">
  ...
  <Card icon="shield-cat" href="/data-api/evm/nft/index" title="NFT API">
    Metadata, floor prices, transfers and ownership.
  </Card>
  <Card icon="chart-candlestick" href="/data-api/evm/price/index" title="Price API">
    Real-time crypto prices, OHLC, trading volume.
  </Card>
  <Card icon="chart-line-up" href="/data-api/evm/defi/index" title="DeFi API">
    DeFi positions, liquidity, reserves and token pairs.
  </Card>
  <Card icon="cubes" href="/data-api/evm/blockchain/index" title="Blockchain API">
