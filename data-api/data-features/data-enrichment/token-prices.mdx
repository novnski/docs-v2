...
This makes token prices safe to use in downstream features such as [Token Balances](/data-api/evm/wallet/token-balances), [Wallet Net Worth](/data-api/evm/wallet/net-worth), [PnL](/data-api/evm/wallet/wallet-pn-l) and many more.
