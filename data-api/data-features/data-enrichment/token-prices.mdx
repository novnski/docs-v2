...
This makes token prices safe to use in downstream features such as [Token Balances](/data-api/evm-api/wallet-api/token-balances), [Wallet Net Worth](/data-api/evm-api/wallet-api/net-worth), [PnL](/data-api/evm-api/wallet-api/pn-l/wallet-pn-l) and many more.
