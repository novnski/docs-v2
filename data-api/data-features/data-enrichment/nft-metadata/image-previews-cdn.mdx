...
description: "Generate and serve optimized NFT image previews via Moralis CDN for faster loading and better user experiences."
---
...
- [NFT API Overview](/data-api/evm-api/nft-api/nft-api-overview)
...
As of **April 2024**, enabling `media_items=true` is **free** and does **not consume additional compute units (CUs)** 🎉.
