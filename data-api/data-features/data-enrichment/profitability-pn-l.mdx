...
description: "Analyze realized wallet and token profitability using Moralis PnL endpoints. Learn how realized PnL is calculated, supported swaps, pricing logic, chain coverage, and known limitations. "
---
...
- [Wallet PnL Summary](/data-api/evm-api/wallet-api/net-worth-and-pn-l/wallet-pn-l-summary)\
  High-level profitability metrics for a wallet
- [Wallet PnL Breakdown](/data-api/evm-api/wallet-api/pn-l/wallet-pn-l)\
  Token-by-token profitability details
- [Top Traders by Token](/data-api/evm-api/token-api/advanced-signals/top-traders)\
...
- **Cost basis / realized trade data** from the [PnL endpoints](/data-api/evm-api/wallet-api/pn-l/wallet-pn-l)
- **Real-time token balances + real-time prices** from the [Token Balances](/data-api/evm-api/wallet-api/token-balances) endpoint
...
- **_Native tokens are supported for PnL_**, **but only when traded against stablecoins**.
