---
title: "NFT Rarity"
description: "Understand how Moralis calculates NFT rarity across collections using trait frequency analysis, rarity scores, rankings, and refreshable on-demand processing for ERC721 and ERC1155 NFTs. "
---
...
- [NFT API Overview](/data-api/evm-api/nft-api/index)
...
- `rarity_label`\
  ...
  _(e.g. “Top 1% trait”, “Top 10% trait”)_
...
- [Metadata Resyncing](/data-api/evm-api/nft-api/utilities/resync-nft-metadata)
- [Rarity Resyncing](/data-api/evm-api/nft-api/utilities/resync-nft-traits)
