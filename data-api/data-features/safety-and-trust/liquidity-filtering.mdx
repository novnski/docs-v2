...
description: "Understand how Moralis uses liquidity filtering to protect price accuracy, including default thresholds, how pair-side liquidity is evaluated for both tokens in a pool, endpoint behavior, and custom liquidity controls."
---
...
- [Wallet Token Balances](/data-api/evm-api/wallet-api/token-balances) (with prices)
...
- [Get Token Price](/data-api/evm-api/token-api/endpoints/token-price)\
