---
title: "Token Search"
description: "Token Search lets you discover tokens across multiple blockchains using names, symbols, token address or DEX pair addresses, with built-in ranking and verification signals to surface high-quality results."
---
...
- `isVerifiedContract`\
  When `true`, only [verified tokens](/v1-0/data-api/data-features/safety-and-trust/verified-contracts) are returned.\
  Default: `false`
- `boostVerifiedContracts`\
  When `true`, [verified tokens](/v1-0/data-api/data-features/safety-and-trust/verified-contracts) are ranked higher.\
  Default: `true`
...
Token Search applies additional weighting to [**verified tokens**](/v1-0/data-api/data-features/safety-and-trust/verified-contracts) to improve result quality.
