...
description: "Filtered Tokens enables powerful, multi-chain token discovery using advanced metrics, filters, and time-based analysis."
---
...
### Trading Metrics _(time-based)_
...
### Holder & Flow Metrics _(time-based)_
...
Use [Token Categories](/data-api/evm-api/token-api/search-and-discovery/token-categories) to identify all supported categories.
