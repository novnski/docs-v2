...
description: "Spam detection helps you identify and handle potentially harmful contracts in the Web3 ecosystem, in real time."
---
...
Many Moralis endpoints (such as [Token Balances](/data-api/wallet-api/endpoints/token-balances)) support **excluding spam contracts** directly at query time.

## ERC20 Tokens & Token Scores

For ERC20 tokens, spam detection works well alongside **Token Scores**.
