...
<Frame>
  <img src="/images/onchain-skills-install.png" alt="Installing Moralis Onchain Skills via npx skills add novnski/onchain-skills" />
</Frame>
...
- **Token** (22) — prices, metadata, pairs, DEX swaps, analytics, security scores
...
- **Discovery** (13) — trending tokens
- **Other** (14) — address resolution, token search, candlesticks
...
**EVM (40+):** Ethereum, Polygon, BNB Smart Chain, Arbitrum, Optimism, Avalanche, Base, Sei, Monad, and more.
