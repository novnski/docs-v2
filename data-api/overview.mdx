...
description: "The universal multichain Data API provides a single, consistent interface for accessing blockchain data across 30+ supported chains, including Ethereum, Solana, Bitcoin, Base, Binance Smart Chain, and more. It standardizes complex on-chain data into clean, developer-friendly formats."
---
...
The [Bitcoin API](/data-api/bitcoin/bitcoin-index) brings full Bitcoin coverage — raw blocks and transactions, BTC market data, address activity, and balances — through the same Universal endpoints used for EVM and Solana. Pass `bitcoin` as the chain, with native xpub support across every wallet endpoint.
...
<iframe
  src="https://www.youtube.com/embed/O8PXFkN71oo"
  title="Moralis Data API Overview – Fetch Onchain Data at Scale"
  width="100%"
  height="400"
  frameBorder="0"
