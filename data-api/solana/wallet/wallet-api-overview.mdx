...
- [**Native Balance**](/data-api/solana/wallet-api/native-balance) - Get SOL balance
- [**Token Balances**](/data-api/solana/wallet-api/token-balances) - Get SPL token holdings
- [**NFT Balances**](/data-api/solana/wallet-api/nft-balances) - Get NFT holdings
- [**Portfolio**](/data-api/solana/wallet-api/portfolio) - Get complete portfolio
- [**Wallet Swaps**](/data-api/solana/wallet-api/wallet-swaps) - Get swap history
