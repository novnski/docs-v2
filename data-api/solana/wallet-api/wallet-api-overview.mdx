...
description: "Query Solana wallet data including native SOL balance, SPL token holdings, NFT balances, portfolio overview, and swap history."
---
...
- [**Native Balance**](/data-api/solana-api/wallet-api/native-balance) - Get SOL balance
- [**Token Balances**](/data-api/solana-api/wallet-api/token-balances) - Get SPL token holdings
- [**NFT Balances**](/data-api/solana-api/wallet-api/nft-balances) - Get NFT holdings
- [**Portfolio**](/data-api/solana-api/wallet-api/portfolio) - Get complete portfolio
- [**Wallet Swaps**](/data-api/solana-api/wallet-api/wallet-swaps) - Get swap history
