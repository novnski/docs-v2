...
description: "Real-time and historical price data for Solana SPL tokens including current prices, batch queries, and OHLC candlestick data."
---
...
- [**Token Price**](/data-api/solana-api/price-api/token-price) - Get current price for a token
- [**Token Prices (Batch)**](/data-api/solana-api/price-api/token-prices-batch) - Get prices for multiple tokens
- [**OHLC**](/data-api/solana-api/price-api/ohlc) - Get candlestick data for charting
