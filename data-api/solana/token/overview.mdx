...
description: "Comprehensive Solana token data including metadata, prices, swaps, pairs, and advanced analytics for SPL tokens."
---

## Overview

The **Solana Token API** provides complete SPL token data including metadata, real-time prices, swap history, trading pairs, and advanced market metrics.
...
- **Discovery** - Search tokens by name, symbol, or address
...
- **Token Analytics**\
  (volume, pair, and market metrics)
- **DEX Interfaces**\
