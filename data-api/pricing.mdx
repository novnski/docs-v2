...
| Method                                                                                       | CU Cost |
| -------------------------------------------------------------------------------------------- | ------- |
| [searchTokens](/universal-api/token/token-search)                              | 150     |
| [getTokenScore](/universal-api/token/token-score)                              | 100     |
| [getHistoricalTokenScore](/data-api/universal-api/token/token-score-timeseries)          | 150     |
| [getTokenAnalytics](/universal-api/token/token-analytics)                      | 80      |
| [getMultipleTokenAnalytics](/universal-api/token/token-analytics-multi)        | 150     |
| [getTimeSeriesTokenAnalytics](/universal-api/token/token-analytics-timeseries) | 200     |
