...
| Method | CU Cost |
| --- | --- |
| [getWalletProfitability](/data-api/universal/pnl/wallet-pnl) | 50 per requested chain |
| [getWalletProfitabilitySummary](/data-api/universal/pnl/wallet-pnl-summary) | 30 per requested chain |
| [getTopTradersByToken](/data-api/universal/pnl/top-traders) | 50 |

### Token Prices

| Method | CU Cost |
| --- | --- |
| [getTokenPriceTimeSeries](/data-api/universal/token/price/token-price-timeseries) | 50 |
| [getTokenPriceSparkline](/data-api/universal/token/price/token-price-sparkline) | 50 |
