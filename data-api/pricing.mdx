...
| [getHistoricalTokenScore](/universal-api/token/token-score-timeseries)          | 150     |
...
| [getFilteredTokens](/universal-api/token/filtered-tokens)                       | 250     |
| [getTopGainersTokens](/universal-api/token/top-gainers)                         | 250     |
| [getTopLosersTokens](/universal-api/token/top-losers)                           | 250     |
| [getTrendingTokens](/universal-api/token/trending-tokens)                       | 150     |
