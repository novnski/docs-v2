...
| Method                                                                                       | CU Cost |
| -------------------------------------------------------------------------------------------- | ------- |
| [searchTokens](/universal-api/token/endpoints/token-search)                              | 150     |
| [getTokenScore](/universal-api/token/endpoints/token-score)                              | 100     |
| [getHistoricalTokenScore](/data-api/universal-api/token/token-score-timeseries)          | 150     |
| [getTokenAnalytics](/universal-api/token/endpoints/token-analytics)                      | 80      |
| [getMultipleTokenAnalytics](/universal-api/token/endpoints/token-analytics-multi)        | 150     |
| [getTimeSeriesTokenAnalytics](/universal-api/token/endpoints/token-analytics-timeseries) | 200     |
| [getFilteredTokens](/data-api/universal-api/token/filtered-tokens)                       | 250     |
| [getTopGainersTokens](/data-api/universal-api/token/top-gainers)                         | 250     |
| [getTopLosersTokens](/data-api/universal-api/token/top-losers)                           | 250     |
| [getTrendingTokens](/data-api/universal-api/token/trending-tokens)                       | 150     |
