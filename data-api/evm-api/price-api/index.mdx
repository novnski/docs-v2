...
| ----------------------------------------------------------------------------- | ------------------------------ |
| [Token Price](/data-api/evm-api/token-api/endpoints/token-price)              | Get current price for a token  |
| [Token Prices (Batch)](/data-api/evm-api/token-api/prices/token-prices-batch) | Get prices for multiple tokens |
| [OHLC](/data-api/evm-api/price-api/ohlc)                                      | Candlestick data for charting  |
| [Collection Floor Price](/data-api/evm-api/price-api/collection-floor-price)  | Current NFT floor price        |
| [Historical Floor Price](/data-api/evm-api/price-api/timeseries-floor-price)  | Floor price over time          |