...
|----------|-------------|
| [Get Block by Hash](/data-api/reference/block-by-hash) | Retrieve block data by hash |
| [Get Block by Date](/data-api/reference/block-by-date) | Find block closest to a timestamp |
| [Get Transaction](/data-api/reference/transaction-by-hash) | Get transaction details by hash |
| [Decoded Transaction](/data-api/reference/transaction-by-hash-decoded) | Get decoded transaction data |
| [Address Transactions](/data-api/reference/address-transactions) | Get all transactions for an address |
