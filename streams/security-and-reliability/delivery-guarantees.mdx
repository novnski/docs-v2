...
description: "Learn how Moralis reliably delivers blockchain data, including retry behavior, durability, and how events are protected from data loss."
---
...
## What Moralis Does _Not_ Guarantee
...
Moralis does not attempt to deliver each event _exactly once_.
