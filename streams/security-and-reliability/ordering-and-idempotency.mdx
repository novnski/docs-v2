...
description: "Learn how Moralis delivers events without strict ordering guarantees, and how to design idempotent consumers that handle retries, duplicates, and replays safely."
---
...
- **Bitcoin** — `txid` (each transaction is delivered twice, once for the mempool phase and once for the confirmed phase; upsert on the second delivery to flip `confirmed`).
