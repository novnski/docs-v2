...
description: "Learn how Moralis Streams identifies and flags potential spam contracts in webhook payloads, helping you filter or handle suspicious on-chain activity safely."
---
