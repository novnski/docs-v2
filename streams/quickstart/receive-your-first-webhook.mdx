...
description: "Understand the webhook lifecycle, payload structure, and how to handle confirmed and unconfirmed webhooks from Moralis Streams."
---
...
| `erc20Transfers` | Decoded ERC20 transfer events (included) |
| `erc20Approvals` | Decoded ERC20 approval events (included) |
| `nftTransfers` | Decoded NFT transfer events (included) |
| `nftApprovals` | Decoded NFT approval events (included) |
