...
- **Included decoded data:** ERC-20 transfers, ERC-20 approvals, NFT transfers (ERC-721 / ERC-1155), and NFT approvals are decoded into clean fields at no extra record cost
...
- **`erc20Transfers` / `erc20Approvals`** — automatically decoded from logs, included
- **`nftTransfers` / `nftApprovals`** — automatically decoded for ERC-721 and ERC-1155, included
...
- **Token transfer tracking** — ERC-20 movements (airdrops, payments, vesting) decoded and included
...
<iframe
  src="https://www.youtube.com/embed/k_hk9Pchjc8"
  title="Monitor Onchain Events"
  width="100%"
  height="400"
  frameBorder="0"
