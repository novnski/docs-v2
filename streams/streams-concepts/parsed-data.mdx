---
title: "Parsed Data"
description: "Learn how to extract typed, decoded data from Streams webhooks across EVM (ERC-20 / NFT transfers, contract events), Bitcoin (UTXO outputs), and Solana (SPL balance snapshots, instructions)."
---
