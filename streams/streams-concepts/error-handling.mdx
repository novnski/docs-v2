...
description: "Understand how Streams handles webhook failures, retries, error states, termination, and how to recover from delivery issues safely."
---
...
For block-level recovery, use **Replay Block** (see _Retries & Replays_).
