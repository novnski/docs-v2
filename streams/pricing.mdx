---
title: "Pricing"
description: "Understand how Streams API usage is calculated using records and compute units across EVM, Bitcoin, and Solana — and learn how to optimize your costs."
---
...
<Info>
Only webhooks with `confirmed: true` incur charges. Unconfirmed webhooks (`confirmed: false`) have `x-records-charged: 0` and are included.
</Info>

For each match, you receive two webhooks:

1. **Unconfirmed** — sent when the transaction is included in a block.
