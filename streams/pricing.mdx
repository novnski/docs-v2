...
<Note>
On Bitcoin, the unconfirmed delivery is sent the moment the transaction enters the mempool. On Solana, the unconfirmed delivery is sent when the slot is produced. The unconfirmed delivery is free in all cases.
</Note>
