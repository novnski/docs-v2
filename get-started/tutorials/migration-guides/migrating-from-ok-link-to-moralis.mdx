...
| ------ | ---------------------- | -------------------------------------------------------------------------------- |
| Solana | Get Sol Portfolio      | [Documentation](/data-api/solana/reference/get-sol-portfolio) |
| Solana | Get Wallet NFTs        | [Documentation](/data-api/solana/reference/get-wallet-nfts)  |
| Solana | Get Native SOL Balance | [Documentation](/data-api/solana/reference/sol-balance)      |
...
| Chain  | Moralis Equivalent | Documentation                                                          |
| ------ | ------------------ | ---------------------------------------------------------------------- |
| Solana | Get SPL Token Info | [Documentation](/data-api/solana/reference/get-spl) |
...
| Chain  | Moralis Equivalent           | Documentation                                                                       |
| ------ | ---------------------------- | ----------------------------------------------------------------------------------- |
| Solana | Get Wallet Swap Transactions | [Documentation](/data-api/solana/reference/get-wallet-swap-txs) |
...
| Chain | Moralis Equivalent          | Documentation                                                                                  |
| ----- | --------------------------- | ---------------------------------------------------------------------------------------------- |
| EVM   | Get NFT Collection Metadata | [Documentation](/data-api/evm/reference/get-metadata-for-nft-contract) |
...
| Chain | Moralis Equivalent   | Documentation                                                                  |
| ----- | -------------------- | ------------------------------------------------------------------------------ |
| EVM   | Get NFTs by Contract | [Documentation](/data-api/evm/reference/get-contract-nfts) |
...
| Chain | Moralis Equivalent         | Documentation                                                            |
| ----- | -------------------------- | ------------------------------------------------------------------------ |
| EVM   | Get NFT Owners by Contract | [Documentation](/data-api/evm/reference/get-nft-owners) |
...
| Chain | Moralis Equivalent              | Documentation                                                                                    |
| ----- | ------------------------------- | ------------------------------------------------------------------------------------------------ |
| EVM   | Get NFT Floor Price by Contract | [Documentation](/data-api/evm/reference/get-nft-floor-price-by-contract) |
...
| Chain  | Moralis Equivalent   | Documentation                                                                      |
| ------ | -------------------- | ---------------------------------------------------------------------------------- |
| EVM    | Get NFT Metadata     | [Documentation](/data-api/evm/reference/get-nft-metadata)        |
| Solana | Get SOL NFT Metadata | [Documentation](/data-api/solana/reference/get-sol-nft-metadata) |
...
| Chain | Moralis Equivalent         | Documentation                                                                      |
| ----- | -------------------------- | ---------------------------------------------------------------------------------- |
| EVM   | Get NFT Owners by Token ID | [Documentation](/data-api/evm/reference/get-nft-token-id-owners) |
...
| Chain | Moralis Equivalent         | Documentation                                                                            |
| ----- | -------------------------- | ---------------------------------------------------------------------------------------- |
| EVM   | Get NFT Contract Transfers | [Documentation](/data-api/evm/reference/get-nft-contract-transfers) |
| EVM   | Get NFT Trades             | [Documentation](/data-api/evm/reference/get-nft-trades)             |
...
| Chain  | Moralis Equivalent | Documentation                                                                |
| ------ | ------------------ | ---------------------------------------------------------------------------- |
| EVM    | Get Wallet NFTs    | [Documentation](/data-api/evm/reference/get-wallet-nfts)    |
| Solana | Get SOL NFTs       | [Documentation](/data-api/solana/reference/get-sol-nfts) |
...
| Chain | Moralis Equivalent  | Documentation                                                                      |
| ----- | ------------------- | ---------------------------------------------------------------------------------- |
| EVM   | Get Filtered Tokens | [Documentation](/data-api/evm/reference/get-filtered-tokens) |
...
| Chain  | Moralis Equivalent        | Documentation                                                                                        |
| ------ | ------------------------- | ---------------------------------------------------------------------------------------------------- |
| EVM    | Get Multiple Token Prices | [Documentation](/data-api/evm/reference/get-multiple-token-prices)                   |
| EVM    | Get OHLCV by Pair Address | [Documentation](/data-api/evm/reference/get-ohlcv-by-pair-address)                   |
| Solana | Get Multiple Token Prices | [Documentation](/data-api/solana/reference/price/get-multiple-token-prices) |
| Solana | Get OHLCV by Pair Address | [Documentation](/data-api/solana/reference/price/get-ohlcv-by-pair-address) |
...
| Chain  | Moralis Equivalent  | Documentation                                                                            |
| ------ | ------------------- | ---------------------------------------------------------------------------------------- |
| EVM    | Get Token Metadata  | [Documentation](/data-api/evm/reference/get-token-metadata)         |
| EVM    | Get Token Analytics | [Documentation](/data-api/evm/reference/get-token-analytics)       |
| Solana | Get Token Metadata  | [Documentation](/data-api/solana/reference/get-token-metadata)   |
| Solana | Get Token Analytics | [Documentation](/data-api/solana/reference/get-token-analytics) |
...
| Chain  | Moralis Equivalent         | Documentation                                                                                      |
| ------ | -------------------------- | -------------------------------------------------------------------------------------------------- |
| EVM    | Get Token Pairs            | [Documentation](/data-api/evm/reference/get-token-pairs)                             |
| Solana | Get Token Pairs by Address | [Documentation](/data-api/solana/reference/get-token-pairs-by-address) |
...
| Chain | Moralis Equivalent      | Documentation                                                                          |
| ----- | ----------------------- | -------------------------------------------------------------------------------------- |
| EVM   | Get Transaction         | [Documentation](/data-api/evm/reference/get-transaction)                 |
| EVM   | Get Decoded Transaction | [Documentation](/data-api/evm/reference/get-decoded-transaction) |
...
| -------- | ------------------ | -------------------------------- |
| Webhooks | Streams API        | [Documentation](/streams/evm) |
