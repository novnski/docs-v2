...
For listening to smart contracts, you can add the [Filters feature](/streams/evm/streams-configuration/filter-streams) to filter out results that only fulfill certain criteria. This is useful for specific use cases such as whale monitoring.
