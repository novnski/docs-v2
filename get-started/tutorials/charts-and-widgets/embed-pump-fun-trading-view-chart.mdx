...
1. Go to **[Moralis Price Chart Widget](https://moralis.com/crypto-price-chart-widget/)**.
...
## Build a TradingView app in 5 minutes

<iframe
  src="https://www.youtube.com/embed/JJUBVOEkNH8"
  title="Build a TradingView app in 5 minutes"
  width="100%"
  height="400"
  frameBorder="0"
