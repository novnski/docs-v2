...
All Moralis plans come with generous monthly request limits. The number of included requests depends on your plan - see the [product pricing pages](#cu-cost) for details.
