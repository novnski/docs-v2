...
- [Get Block by Date](/data-api/evm-api/block-api/date-to-block) - Find the block number closest to a given date or timestamp
...
- [API Reference](/data-api/evm-api/block-api/date-to-block) - Full API documentation
