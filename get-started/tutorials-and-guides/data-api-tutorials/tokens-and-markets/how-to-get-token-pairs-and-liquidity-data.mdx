...
- [Get Token Pairs](/data-api/evm/token/swaps-and-pairs/token-pairs) - Fetch all trading pairs and liquidity data for a token
...
- [Get Pair Stats](/data-api/evm/token/swaps-and-pairs/pair-stats) - detailed market data 
