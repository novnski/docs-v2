...
- [Get Verbose Transactions](/data-api/evm-api/transaction-api/verbose-transactions) - Fetch transactions with internal calls and detailed execution data
...
- [Get Wallet History](/get-started/tutorials-and-guides/data-api-tutorials/wallets-and-accounts/how-to-get-full-wallet-transaction-history-eoa-and-smart-accounts) - Get complete transaction history
- [Get Transaction by Hash](/get-started/tutorials-and-guides/data-api-tutorials/blocks-and-transactions/how-to-get-a-blockchain-transaction-by-hash) - Get specific transaction details
- [API Reference](/data-api/evm-api/transaction-api/verbose-transactions) - Full API documentation
