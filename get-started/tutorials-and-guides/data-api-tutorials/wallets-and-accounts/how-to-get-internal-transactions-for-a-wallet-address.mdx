...
- [Get Decoded Transactions](/data-api/evm-api/wallet-api/decoded-transactions) - Fetch transactions with internal calls and detailed execution data
...
- [Get Wallet History](/data-api/evm-api/wallet-api/activity/wallet-history) - Get complete transaction history
- [Get Transaction by Hash](/data-api/evm-api/blockchain-api/transaction-by-hash-decoded) - Get specific transaction details