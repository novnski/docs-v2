...
- [Get Native Balance](/data-api/evm-api/wallet-api/tokens/native-balance) - Fetch the native token balance for any wallet
...
- [Get Token Balances](/data-api/evm-api/wallet-api/token-balances) - Fetch ERC20 token balances
- [Get Multi-Chain Activity](/data-api/evm-api/wallet-api/activity/chain-activity) - See activity across chains