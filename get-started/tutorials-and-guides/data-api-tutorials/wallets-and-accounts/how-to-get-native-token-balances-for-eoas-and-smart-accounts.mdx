...
- [Get Native Balance](/data-api/evm/wallet/tokens/native-balance) - Fetch the native token balance for any wallet
...
- [Get Multi-Chain Activity](/data-api/evm/wallet/activity/chain-activity) - See activity across chains