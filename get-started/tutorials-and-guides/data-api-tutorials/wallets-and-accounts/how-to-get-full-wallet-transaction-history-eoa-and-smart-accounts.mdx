...
- [Get Wallet History](/data-api/evm/wallet/activity/wallet-history) - Fetch the complete transaction history for any wallet
...
- [NFT Balances](/data-api/evm/wallet/nft-balances/nft-balances) - Fetch NFTs by wallet
