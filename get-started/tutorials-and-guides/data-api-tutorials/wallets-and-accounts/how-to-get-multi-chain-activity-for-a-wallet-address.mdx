...
- [Get Chain Activity](/data-api/evm-api/wallet-api/activity/chain-activity) - Detect which chains a wallet has been active on
...
- [Get Wallet History](/data-api/evm-api/wallet-api/activity/wallet-history) - Get full transaction history
- [Get Token Balances](/data-api/evm-api/wallet-api/token-balances) - Fetch token balances