...
- [Get Chain Activity](/data-api/evm-api/wallet-api/chain-activity) - Detect which chains a wallet has been active on
...
- [Get Wallet History](/get-started/tutorials-and-guides/data-api-tutorials/wallets-and-accounts/how-to-get-full-wallet-transaction-history-eoa-and-smart-accounts) - Get full transaction history
- [Get Token Balances](/get-started/tutorials-and-guides/data-api-tutorials/tokens-and-markets/how-to-get-erc-20-token-balances-for-a-wallet) - Fetch token balances
- [API Reference](/data-api/evm-api/wallet-api/chain-activity) - Full API documentation
