...
- [Get Chain Activity](/data-api/evm/wallet/activity/chain-activity) - Detect which chains a wallet has been active on
...
- [Get Wallet History](/data-api/evm/wallet/activity/wallet-history) - Get full transaction history
