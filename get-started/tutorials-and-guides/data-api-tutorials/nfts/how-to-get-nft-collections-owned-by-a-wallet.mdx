...
- [Get NFT Metadata](/data-api/evm/nft/endpoints/nft-metadata) - Get detailed NFT metadata
- [Get NFT Floor Prices](/data-api/evm/nft/floor-price-collection) - Fetch collection floor prices
