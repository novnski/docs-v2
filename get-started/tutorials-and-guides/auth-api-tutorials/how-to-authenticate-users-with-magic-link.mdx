...
You can start this tutorial if you already have a NextJS dapp with [MetaMask sign-in](/get-started/tutorials-and-guides/auth-api-tutorials/how-to-authenticate-users-with-meta-mask) functionality.
