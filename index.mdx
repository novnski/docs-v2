...
<Columns cols={4}>
  <Card title="Data APIs" icon="database" href="/data-api" cta="Fetch Crypto Data">
    
  </Card>
  <Card title="Streams" icon="monitor-waveform" href="/streams" cta="Monitor Crypto Data">
    
  </Card>
  <Card title="Datashare" icon="file-export" href="/datashare" cta="Export Crypto Data">
    
  </Card>
  <Card title="Data Indexer" icon="gear-code" href="/data-indexer" cta="Index Crypto Data">
...
The [Data API](/data-api) provides a **single**, **consistent interface** for accessing decoded and enriched onchain data across EVM and Solana chains.
...
[Streams](/streams) enables **real-time access to onchain events** through webhooks, allowing applications to react instantly without polling the blockchain.
...
[Datashare](/datashare) provides access to **large-scale historical and ongoing onchain datasets**, delivered directly into cloud storage or data warehouses.
...
The [Data Indexer](/data-indexer) is a managed, enterprise-grade indexing solution for building **custom onchain data pipelines**.
...
| ----------------------------------- | --------------------------- | ---------------------------- | --------------------------------- | -------------------------------------- |
| [Data API](/data-api)         | Read onchain data           | On-demand (request/response) | Decoded, enriched blockchain data | Apps, dashboards, backend services     |
| [Streams](/streams)           | React to onchain events     | Real-time webhooks           | Live wallet & contract events     | Notifications, automation, monitoring  |
| [Datashare](/datashare)       | Analyze data at scale       | Batch & scheduled exports    | Large-scale historical datasets   | Analytics, BI, AI/ML, compliance       |
| [Data Indexer](/data-indexer) | Build custom data pipelines | Continuous indexing          | Custom-structured onchain data    | Enterprise systems, internal analytics |