...
<Columns cols={4}>
  <Card title="Data APIs" icon="database" img="/images/moralis-data-api-logo.png" href="/data-api/index" cta="Fetch Crypto Data">
  </Card>

  <Card title="Streams" icon="monitor-waveform" img="/images/moralis-streams-logo.png" href="/streams" cta="Monitor Crypto Data">
  </Card>

  <Card title="Datashare" icon="file-export" img="/images/moralis-datashare-logo.png" href="/datashare" cta="Export Crypto Data">
  </Card>

  <Card title="Data Indexer" icon="gear-code" img="/images/moralis-data-indexer-logo.png" href="/data-indexer" cta="Index Crypto Data">
  </Card>
</Columns>
