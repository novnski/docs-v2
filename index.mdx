...
description: "One platform for real-time blockchain data - APIs, streams, datasets and enterprise indexing powering wallets, compliance, AI, and next-gen finance."
mode: "wide"
---
...
<Columns cols={4}>
  <Card title="Data APIs" icon="database" href="/data-api/overview" cta="Fetch Crypto Data">
    
  </Card>
  <Card title="Streams" icon="monitor-waveform" href="/streams/overview" cta="Monitor Crypto Data">
    
  </Card>
  <Card title="Datashare" icon="file-export" href="/datashare/overview" cta="Export Crypto Data">
    
  </Card>
  <Card title="Data Indexer" icon="gear-code" href="/data-indexer/overview" cta="Index Crypto Data">
...
The [Data API](/data-api/overview) provides a **single**, **consistent interface** for accessing decoded and enriched onchain data across EVM and Solana chains.
...
[Streams](/streams/overview) enables **real-time access to onchain events** through webhooks, allowing applications to react instantly without polling the blockchain.
...
[Datashare](/datashare/overview) provides access to **large-scale historical and ongoing onchain datasets**, delivered directly into cloud storage or data warehouses.
...
The [Data Indexer](/data-indexer/overview) is a managed, enterprise-grade indexing solution for building **custom onchain data pipelines**.
...
| ----------------------------------- | --------------------------- | ---------------------------- | --------------------------------- | -------------------------------------- |
| [Data API](/data-api/overview)         | Read onchain data           | On-demand (request/response) | Decoded, enriched blockchain data | Apps, dashboards, backend services     |
| [Streams](/streams/overview)           | React to onchain events     | Real-time webhooks           | Live wallet & contract events     | Notifications, automation, monitoring  |
| [Datashare](/datashare/overview)       | Analyze data at scale       | Batch & scheduled exports    | Large-scale historical datasets   | Analytics, BI, AI/ML, compliance       |
| [Data Indexer](/data-indexer/overview) | Build custom data pipelines | Continuous indexing          | Custom-structured onchain data    | Enterprise systems, internal analytics |