...
<Columns cols={4}>
  ...
  <Card title="Data Feeds" icon="gear-code" img="/images/moralis-data-indexer-logo.png" href="/data-indexer">
    Deliver Crypto Data
  </Card>
</Columns>
...
[Data Feeds](/data-indexer/index) is a managed, enterprise-grade solution for building **custom onchain data pipelines**.
...
| [Data Feeds](/data-indexer/index) | Deliver custom data pipelines | Continuous indexing | Custom-structured onchain data | Enterprise systems, internal analytics |
