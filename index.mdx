...
| ---------------- | --------------------------- | ---------------------------- | --------------------------------- | -------------------------------------- |
| [Data API](/data-api/index)     | Read on-chain data          | On-demand (request/response) | Decoded, enriched blockchain data | Apps, dashboards, backend services     |
| [Streams](/streams/index)      | React to on-chain events    | Real-time webhooks           | Live wallet & contract events     | Notifications, automation, monitoring  |
...
| [Data Indexer](/data-indexer/index) | Build custom data pipelines | Continuous indexing          | Custom-structured on-chain data   | Enterprise systems, internal analytics |
