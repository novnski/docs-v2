...
You can start this tutorial if you already have a NextJS dapp with [MetaMask sign-in](/how-to-authenticate-users-with-meta-mask) functionality.Installing the Web3Auth Wagmi Connector
